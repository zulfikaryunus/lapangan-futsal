...
<div align='center'>
  <form action="proseslogin.php" method="POST" onSubmit="validasi()">
  <h1>Masuk</h1>
  <table>
  <tbody>
  ...
  <tr><td colspan="2" align="right"><input  type="submit" value="login" class="tombol"> <input value="Batal" type="reset"></td></tr>
  </tbody>
  </table>
  </form>
</div>
